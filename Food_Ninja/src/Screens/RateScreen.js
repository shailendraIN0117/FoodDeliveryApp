      ...
      <View style={styles.content}>
        <View style={styles.ProfileContainer}>
          ...
          <Text style={styles.ProfileSubTitle}>
            {skip ? 'Please rate your Restaurant' : subtitle}
          </Text>
          <View style={styles.startContainer}>
            {stars.map((_, index) => (
              <TouchableOpacity key={index} onPress={() => setStar(index - 4)}>
                <Image
                  source={
                    star < index - 4 ? imagePath.LightStar : imagePath.DarkStar
                  }
        ...
        <View style={{marginBottom: 30}}>
          ...
          <View style={styles.buttonConatiner}>
            ...
            <ChatBox
              ...
              msgTextStyle={styles.skipBtn}
              onPress={() => {
                navigation.navigate(navigationString.VOUCHER_PROMO);
                setSkip(true);
              }}
            />
          </View>
